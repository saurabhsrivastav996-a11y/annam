...
export const users = [
  { name: 'Vikram Rao', email: 'customer@annam.dev', role: 'customer', phone: '+91-98450-11111',
    address: { street: '12 Kondapur Main Rd', city: 'Hyderabad', state: 'TG', zip: '500084' } },
...
export const restaurants = [
  {
    ...
    location: { type: 'Point', coordinates: [78.4392, 17.4126] },
    menu: [
  ...
  },
  {
    ...
    address: '45 Hitech City Main Rd, Madhapur, Hyderabad',
    cuisineType: 'South Indian',
    category: 'both',
    phone: '+91-80-4000-2222',
    isTransparentKitchen: false,
    imageUrl: img('photo-1555939594-58d7cb561ad1'),
    location: { type: 'Point', coordinates: [78.3908, 17.4485] },
    menu: [
  ...
  },
  {
    ...
    address: '78 Gachibowli Main Rd, Gachibowli, Hyderabad',
    cuisineType: 'Healthy',
    category: 'veg',
